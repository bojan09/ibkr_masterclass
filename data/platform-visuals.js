...
const TWS_ORDER_ENTRY_UPDATED = "2026-04-08";
...
const RAW_VISUALS = [
  ...
  guideVisual({
    ...
    platformId: "tws-mosaic",
    missionIds: ["tws-mosaic-layout", "tws-window-grouping", "tws-chart", "tws-customize"],
    stepLinks: {
      ...
      "tws-chart": { steps: [1], caption: "Find the Chart Panel inside the Mosaic workspace before checking its linked symbol." },
  ...
  guideVisual({
    id: "tws-monitor",
    platformId: "tws-mosaic",
    missionIds: ["tws-mosaic-layout", "tws-monitor", "tws-portfolio", "tws-customize"],
    stepLinks: {
      "tws-mosaic-layout": { steps: [2], caption: "Inspect the Monitor Panel as one of the principal tools inside the wider Mosaic workspace." },
      ...
      "tws-customize": { steps: [2, 3], caption: "Use a populated Monitor Panel to verify that essential tabs remain present after layout changes." },
    },
  ...
  guideVisual({
    id: "tws-order-entry",
    platformId: "tws-mosaic",
    missionIds: ["tws-order-entry", "tws-order-preview", "tws-option-chain"],
    stepLinks: {
      ...
      "tws-option-chain": { steps: [3], caption: "Confirm that the selected option contract reaches Order Entry with the intended identity." },
    },
    ...
    sourceUpdated: TWS_ORDER_ENTRY_UPDATED,
  ...
  guideVisual({
    id: "tws-monitor-portfolio",
    platformId: "tws-mosaic",
    missionIds: ["tws-monitor", "tws-portfolio"],
    stepLinks: {
      "tws-monitor": { steps: [2], caption: "Recognize Portfolio in the Monitor tab menu before opening the account-position view." },
      "tws-portfolio": { steps: [1], caption: "Use the Monitor plus menu to open Portfolio when it is not already visible." },
    },
    title: "Open Portfolio in Monitor",
    alt: "Official TWS screenshot showing the Monitor Panel plus menu with Portfolio available as a tab choice.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/monitor-panel.htm",
    imagePath: "resources/images/portfolio.png",
    sourceLabel: "TWS User Guide — Monitor Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Portfolio contents and account totals depend on the connected PaperTrader account.",
  }),
  guideVisual({
    id: "tws-monitor-watchlist-create",
    platformId: "tws-mosaic",
    missionIds: ["tws-window-grouping", "tws-monitor"],
    stepLinks: {
      "tws-window-grouping": { steps: [3], caption: "Open a Watchlist inside Monitor before testing which color-linked panels follow its selection." },
      "tws-monitor": { steps: [2], caption: "Recognize the New Watchlist choice within the Monitor tab menu." },
    },
    title: "Create a Monitor Watchlist",
    alt: "Official TWS screenshot showing the Monitor Panel menu used to create and open a new Watchlist tab.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/monitor-panel.htm",
    imagePath: "resources/images/watchlist.png",
    sourceLabel: "TWS User Guide — Monitor Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Watchlists may synchronize across IBKR platforms connected to the same account.",
  }),
  guideVisual({
    id: "tws-monitor-watchlist-add",
    platformId: "tws-mosaic",
    missionIds: ["tws-monitor"],
    stepLinks: {
      "tws-monitor": { steps: [3], caption: "Compare product choices before adding an instrument and observing linked-panel changes." },
    },
    title: "Add a Watchlist instrument",
    alt: "Official TWS screenshot showing the instrument-selection choices presented while adding a symbol to a Monitor Watchlist.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/monitor-panel.htm",
    imagePath: "resources/images/watchlist2.png",
    sourceLabel: "TWS User Guide — Monitor Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Verify product type and exchange instead of accepting the first similarly named result.",
  }),
  guideVisual({
    id: "tws-quote-details",
    platformId: "tws-mosaic",
    missionIds: ["tws-window-grouping", "tws-quote"],
    stepLinks: {
      "tws-window-grouping": { steps: [1], caption: "Locate the Quote Panel symbol area and grouping control before linking its context." },
      "tws-quote": { steps: [3], caption: "Use the detail control to reveal more contract and quote information after identity checks." },
    },
    title: "Quote details control",
    alt: "Official TWS screenshot showing the Quote Panel details arrow beside the selected symbol and quote header.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/quote-panel.htm",
    imagePath: "resources/images/quotedetails.png",
    sourceLabel: "TWS User Guide — Quote Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Expanded details remain subject to market-data entitlement and current session state.",
  }),
  guideVisual({
    id: "tws-quote-advanced",
    platformId: "tws-mosaic",
    missionIds: ["tws-quote"],
    stepLinks: {
      "tws-quote": { steps: [3], caption: "Recognize the expanded Quote Panel before interpreting its additional contract statistics." },
    },
    title: "Expanded Quote Panel",
    alt: "Official TWS screenshot showing the expanded Quote Panel with additional details for the selected contract.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/quote-panel.htm",
    imagePath: "resources/images/quotedetails1.png",
    sourceLabel: "TWS User Guide — Quote Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Additional fields do not remove the need to verify the exact contract and quote state.",
  }),
  guideVisual({
    id: "tws-activity-orders",
    platformId: "tws-mosaic",
    missionIds: ["tws-activity", "tws-order-monitor"],
    stepLinks: {
      "tws-activity": { steps: [2, 3], caption: "Use Orders for pending and completed instructions rather than individual execution records." },
      "tws-order-monitor": { steps: [2], caption: "Locate the paper instruction in Orders by contract, time, and current state." },
    },
    title: "Activity Orders tab",
    alt: "Official TWS screenshot showing the Activity Panel Orders tab with live, canceled, and completed order rows.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/activity-panel.htm",
    imagePath: "resources/images/orders.png",
    sourceLabel: "TWS User Guide — Activity Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Displayed rows and editable fields depend on each paper order's state.",
  }),
  guideVisual({
    id: "tws-activity-trades",
    platformId: "tws-mosaic",
    missionIds: ["tws-activity", "tws-order-monitor"],
    stepLinks: {
      "tws-activity": { steps: [2, 3], caption: "Use Trades to inspect individual executions rather than unfilled order instructions." },
      "tws-order-monitor": { steps: [3], caption: "Compare Trades with Orders only after an execution appears for the intended contract." },
    },
    title: "Activity Trades tab",
    alt: "Official TWS screenshot showing the Activity Panel Trades tab with the day's individual execution records.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/activity-panel.htm",
    imagePath: "resources/images/trades.png",
    sourceLabel: "TWS User Guide — Activity Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "A submitted instruction appears in Trades only when an execution has occurred.",
  }),
  guideVisual({
    id: "tws-activity-summary",
    platformId: "tws-mosaic",
    missionIds: ["tws-activity"],
    stepLinks: {
      "tws-activity": { steps: [2, 3], caption: "Recognize Trade Summary as grouped daily activity rather than a list of pending instructions." },
    },
    title: "Activity Trade Summary",
    alt: "Official TWS screenshot showing the Activity Panel Trade Summary tab with buys and sells grouped by underlying.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/activity-panel.htm",
    imagePath: "resources/images/summary.png",
    sourceLabel: "TWS User Guide — Activity Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Summary grouping can hide execution-level detail available in the Trades tab.",
  }),
  guideVisual({
    id: "tws-activity-pending-menu",
    platformId: "tws-mosaic",
    missionIds: ["tws-order-monitor", "tws-attached-orders"],
    stepLinks: {
      "tws-order-monitor": { steps: [2], caption: "Open the selected pending order's menu only after confirming its contract and state." },
      "tws-attached-orders": { steps: [2], caption: "Recognize the Attach action available from the selected pending parent order." },
    },
    title: "Pending-order actions",
    alt: "Official TWS screenshot showing the Activity Orders right-click menu with modify, cancel, margin, and attach actions.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/activity-panel.htm",
    imagePath: "resources/images/rightclick.png",
    sourceLabel: "TWS User Guide — Activity Panel",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Actions depend on order state; use the intended paper instruction and wait for status confirmation.",
  }),
  guideVisual({
    id: "tws-order-advanced-menu",
    platformId: "tws-mosaic",
    missionIds: ["tws-order-entry", "tws-order-preview"],
    stepLinks: {
      "tws-order-entry": { steps: [3], caption: "Recognize the Advanced menu without adding attributes during the basic order-entry exercise." },
      "tws-order-preview": { steps: [2], caption: "Open Advanced to locate margin and attached-order review controls before transmission." },
    },
    title: "Order Entry Advanced menu",
    alt: "Official TWS screenshot showing the Mosaic Order Entry Advanced menu with additional order tools and attributes.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/advanced-button.htm",
    imagePath: "resources/images/advanced1.png",
    sourceLabel: "TWS User Guide — Advanced Button",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Advanced attributes change order behavior and require separate understanding before use.",
  }),
  guideVisual({
    id: "tws-order-bracket",
    platformId: "tws-mosaic",
    missionIds: ["tws-attached-orders"],
    stepLinks: {
      "tws-attached-orders": { steps: [2, 3], caption: "Verify parent and child sides, quantities, prices, and activation relationships in the bracket panel." },
    },
    title: "Attach a bracket order",
    alt: "Official TWS screenshot showing the Order Entry Advanced panel used to attach profit-taker and stop-loss bracket children.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/advanced-button.htm",
    imagePath: "resources/images/advanced7.png",
    sourceLabel: "TWS User Guide — Advanced Button",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Attached orders create additional instructions; verify activation and cancellation relationships before review.",
  }),
  guideVisual({
    id: "tws-order-margin-check",
    platformId: "tws-mosaic",
    missionIds: ["tws-order-preview", "tws-risk-review"],
    stepLinks: {
      "tws-order-preview": { steps: [2, 3], caption: "Locate Check Margin and compare its estimate with the complete written order intent." },
      "tws-risk-review": { steps: [1], caption: "Use Check Margin as one changing account estimate, not a guarantee that risk is acceptable." },
    },
    title: "Check Margin control",
    alt: "Official TWS screenshot showing the Check Margin control inside the Mosaic Order Entry Advanced panel.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/advanced-button.htm",
    imagePath: "resources/images/advanced11.png",
    sourceLabel: "TWS User Guide — Advanced Button",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Margin estimates can change with prices, positions, account rules, and the complete order.",
  }),
  guideVisual({
    id: "tws-spread-template",
    platformId: "tws-mosaic",
    missionIds: ["tws-combination"],
    stepLinks: {
      "tws-combination": { steps: [2], caption: "Compare spread-template tiles before loading a candidate into Strategy Builder." },
    },
    title: "Strategy Builder spread templates",
    alt: "Official TWS screenshot showing Strategy Builder spread-template tiles with strikes, expirations, quotes, and Greeks.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/option-chain.htm",
    imagePath: "resources/images/spreadtemplate.jpg",
    sourceLabel: "TWS User Guide — Option Chain & Strategy Builder",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Template metrics are dynamic comparisons and do not establish suitability or execution quality.",
  }),
  guideVisual({
    id: "tws-strategy-loaded-spread",
    platformId: "tws-mosaic",
    missionIds: ["tws-combination"],
    stepLinks: {
      "tws-combination": { steps: [2, 3], caption: "Verify the loaded spread's individual legs and combined order fields before preview." },
    },
    title: "Loaded Strategy Builder spread",
    alt: "Official TWS screenshot showing a selected spread loaded into Strategy Builder beneath the option chain.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/option-chain.htm",
    imagePath: "resources/images/optionchain2.png",
    sourceLabel: "TWS User Guide — Option Chain & Strategy Builder",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Recheck action, ratio, expiration, strike, right, multiplier, and net price for every leg.",
  }),
  guideVisual({
    id: "tws-performance-scenarios",
    platformId: "tws-mosaic",
    missionIds: ["tws-risk-review"],
    stepLinks: {
      "tws-risk-review": { steps: [2], caption: "Compare modeled scenario views while remembering that inputs, volatility, and time continually change." },
    },
    title: "Performance Profile scenarios",
    alt: "Official TWS screenshot showing multiple Performance Profile scenario views for an option strategy.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/performance-profile.htm",
    imagePath: "resources/images/performanceprofile.png",
    sourceLabel: "TWS User Guide — Performance Profile",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "Scenario output is modeled and cannot represent every market, liquidity, or assignment outcome.",
  }),
  guideVisual({
    id: "tws-strategy-performance-graph",
    platformId: "tws-mosaic",
    missionIds: ["tws-risk-review"],
    stepLinks: {
      "tws-risk-review": { steps: [2, 3], caption: "Read the payoff graph alongside account exposure, liquidity, concentration, and assignment risk." },
    },
    title: "Strategy Performance Graph",
    alt: "Official TWS screenshot showing the Strategy Performance Graph with modeled profit and loss across underlying prices.",
    sourceUrl: "https://www.ibkrguides.com/traderworkstation/strategy-performance-graph.htm",
    imagePath: "resources/images/strategyperformancegraph.png",
    sourceLabel: "TWS User Guide — Strategy Performance Graph",
    sourceUpdated: TWS_GUIDE_UPDATED,
    productVersionNote: "The graph is a model and does not include every execution, volatility, early-exercise, or assignment outcome.",
  }),
];
