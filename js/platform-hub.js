...
function renderSafety() {
  return `<section class="platform-safety" aria-labelledby="paper-safety-title">
    <div><p class="eyebrow">Mandatory safety gate</p><h1 id="paper-safety-title">Confirm Paper Trading before every exercise</h1><p>The website never connects to IBKR. Open the official application yourself and verify that the login or session is explicitly identified as paper or simulated before following an order mission.</p></div>
...
function renderDetail(platform) {
  return `<div class="platform-detail">
    ...
    <section class="platform-detail__grid"><article><h2>Start safely</h2><ol><li>Install from IBKR's official page.</li><li>Use your authorized paper-trading access.</li><li>Complete the account-mode check.</li><li>Follow each mission and confirm its observable evidence.</li></ol><a class="button button--primary" href="#/platforms/safety">Review safety gate</a></article><article><h2>Official references</h2><ul class="source-list">${renderSources(platform)}</ul><p>Interfaces change. If a label or location differs, stop and verify the current official guide.</p></article></section>
...
export function renderPlatformHub(container, { initialPlatform = "all" } = {}) {
  ...
  container.innerHTML = `<div class="platform-hub"><header class="page-hero"><div><p class="eyebrow">Genuine-platform curriculum</p><h1>Learn the real IBKR applications</h1><p>Install and practice in official IBKR paper-trading software. Use this site for sourced missions, explanations, checks, and platform comparisons.</p></div><div class="page-hero__stat"><strong>2</strong><span>Official platform tracks</span></div></header><section class="platform-grid">${PLATFORMS.map(renderPlatformCard).join("")}</section><aside class="affiliation-note"><strong>Independent educational project</strong><p>IBKR Platform Mastery is not affiliated with, endorsed by, or connected to Interactive Brokers LLC or its affiliates. No brokerage connection is provided.</p></aside></div>`;
}
